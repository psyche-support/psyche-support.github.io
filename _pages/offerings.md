...
- Συναισθηματική ρύθμιση και δυσκολίες στην επεξεργασία συναισθημάτων
...
- Ερωτικές σχέσεις και ζητήματα ζευγαριών – συγκρούσεις, αποχωρισμοί, επαναλαμβανόμενα μοτίβα
